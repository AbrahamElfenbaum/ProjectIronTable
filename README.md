...
- `MapBuilder/` — Map builder grid and tiles (`AMapGrid`, `ATileActor`)
- `Pawns/` — Camera pawn (`ACameraPawn`)
- `PlayerControllers/` — Player controllers (`ABaseCameraController` base, `ASessionController`, `AMapBuilderController`, `AMainScreenController`)
...
- `Input/Build/` — `IMC_Build`, `IA_PlaceTile`, `IA_RotateTile`, `IA_DeleteTile`, `IA_ChangeLevel`, `IA_ToggleTileLock`
