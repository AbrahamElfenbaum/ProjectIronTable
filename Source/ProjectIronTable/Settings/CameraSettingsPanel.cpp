...
void UCameraSettingsPanel::Init()
{
	...
	{
		UCameraSettingsSave* CameraSettingsSave = Cast<UCameraSettingsSave>(UGameplayStatics::LoadGameFromSlot(UCameraSettingsSave::SaveSlotName, 0));
		if (IsValid(CameraSettingsSave))
		{
